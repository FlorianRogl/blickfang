...
const IndividualCourse: React.FC = () => {
    ...
    const courseSlug = "individual-perfection-course";
        ...
        return (
            <div className="min-h-screen flex items-center justify-center px-4" style={{ backgroundColor: '#F2F1ED', paddingTop: '6rem' }}>
                <div className="text-center bg-white p-8 w-full max-w-md rounded-xl shadow-lg">
                    ...
                    <p className="text-gray-600 mb-6">Der Perfektionskurs konnte nicht geladen werden.</p>
                    <button
    ...
    // SEO Schema Setup
    const courseSchemaData = courseSchema(courses.individual);

    const breadcrumbs = breadcrumbSchema([
        { name: 'Home', url: 'https://blickfang-nagelstudio.at/' },
        { name: 'Kurse', url: 'https://blickfang-nagelstudio.at/#services' },
        { name: 'Individual Perfection', url: 'https://blickfang-nagelstudio.at/course/individual-perfection-course' }
    ]);

    const combinedSchema = {
        "@context": "https://schema.org",
        "@graph": [courseSchemaData, breadcrumbs]
    };

    return (
        <>
            <SEO
                title="Individual Perfection Kurs - Individuelles Nageldesign Training"
                description="Individueller Perfektionskurs für fortgeschrittene Nageldesignerinnen. Persönliches 1:1 Training nach deinen Bedürfnissen. Professionelle Weiterbildung bei blickfang."
                canonicalUrl="https://blickfang-nagelstudio.at/course/individual-perfection-course"
                keywords="Individual Training Nageldesign, Nageldesign Perfektionskurs, 1:1 Schulung Nails, Fortgeschrittenen Kurs Nageldesign, Individuelles Nail Training"
                ogType="product"
                    ...
                    <div className="mb-12 sm:mb-16 xl:mb-10 2xl:mb-16 bg-gradient-to-br from-yellow-50 to-lime-50 p-8 sm:p-12 xl:p-6 2xl:p-12 rounded-xl sm:rounded-2xl xl:rounded-xl 2xl:rounded-2xl">
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <p className="text-base sm:text-lg xl:text-base 2xl:text-lg text-gray-700 font-light leading-relaxed">
                                Dieser Kurs ist perfekt für alle, die ihre Technik perfektionieren und auf ein professionelles Level heben möchten.
                                Individuelle Betreuung und maßgeschneidertes Training für maximalen Lernerfolg.
                            </p>
                        </div>
                    </div>
